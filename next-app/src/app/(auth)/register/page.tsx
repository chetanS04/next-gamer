          ...
          {!showRegisterForm ? (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {[
                  { label: 'I’m a Buyer, looking to buy gaming IDs', role: UserRole.BUYER },
                  { label: 'I’m a Seller, looking to sell gaming IDs', role: UserRole.SELLER },
                ].map(({ label, role }) => (
                  <div
                    key={role}
                    onClick={() => setSelectedRole(role)}
                    className={`p-6 cursor-pointer border-2 rounded-lg transition-all duration-200 hover:shadow-md ${selectedRole === role
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div
                        className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedRole === role ? 'border-green-500 bg-green-500' : 'border-gray-300'
                          }`}
                      >
                        {selectedRole === role && <div className="w-2 h-2 rounded-full bg-white"></div>}
                      </div>
                    </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
                ...
                <input
                  ...
                  className={`w-full border px-4 py-2 rounded ${errors.password ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
                ...
                <input
                  ...
                  className={`w-full border px-4 py-2 rounded ${errors.password_confirmation ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
                ...
                <div className="flex items-start">
                  <input type="checkbox" {...register('terms')} className="mt-1 mr-2" />
